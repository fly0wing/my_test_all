...
public class JDBCUtils {
    ...
    private static String m_url = "jdbc:mysql://10.5.12.8:3306/my_test_all";
    private static String m_user = "mytest";
    private static String m_password = "mytest";
    ...
    private static void clearClosedConnection() {
        ...
        while (iterator.hasNext()) {
            ...
            try {
                ...
                iterator.remove();
                if (DEBUG) {
                    logger.info("connection is closed, this connection initial StackTrace");
                    wrapper.debugInfo.printStackTrace();
                }
            }
        }
    ...
    public synchronized static void printDebugMsg(PrintStream out) {
        ...
        msg.append("debug message in " + JDBCUtils.class.getName());
        msg.append("\r\n");
...
class ConnectionWrapper implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method m, Object[] args) throws Throwable {
        ...
        if (CLOSE_METHOD_NAME.equals(m.getName())) {
            JDBCUtils.pushConnectionBackToPool(this);
        } else {
